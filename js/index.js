        ...
        posts.forEach((post) => {
            ...
            if (contentImage.length === 1 && contentImage[0]) {
                ...
                contentImage.forEach((image) => {
                    arr.push(
                        `<img src="${image}" alt="post-image" class="article-post__img--slide">`
                    );
                });
                imageHTML = `<ul class="article-post__img-list">${arr.join(
                    ""
                )}</ul>`;
            }
            ...
            document.querySelector(".main").innerHTML += `
                        <article class="post">
                            <img src="${authorImage}" alt="${authorName}님의 프로필 사진" class="profile-pic" data-accountname="${
                post.author.accountname
            }">
                            <div class="cont-following">
                                <div class="profile">
                                    <p class="tit-post" data-userid="${
                                        post.author._id
                                    }" data-accountname="${
                post.author.accountname
            }"> ${authorName} </p>
                                    <p class="id font-gray" data-accountname="${
                                        post.author.accountname
                                    }">${authorAccount}</p>
                                </div>
                                ...
                                <div class="icon-box font-gray">
                                    ...
                                    <p class="date font-gray">${makeKoreaDate(
                                        updateDate
                                    )}</p>
                                </div>
                                <div class="div-icon">
